...
import 'package:ditonton/data/tv/models/tv_detail_model.dart';
...
void main() {
  ...
  group('get On Air TV', () {
    ...
    test('should return list of TV Series Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/tv/on_air.json'), 200));
      // act
  ...
  group('search movies', () {
    final tSearchResult = TvResponse.fromJson(
            json.decode(readJson('dummy_data/tv/search_money_heist.json')))
        .tvList;
    final tQuery = 'Money';
    ...
    test('should return list of TV Series when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tv/search_money_heist.json'), 200));
      // act
